...
const Projetos = () => {
  ...
  const projetos = [
    ...
    },
    {
      ...
      link: 'https://my-birthday-party-eos0yc2qs-fernandos-projects-66f955c3.vercel.app/',
...

    {
      ...
      descricao: t('Tarefas'),
      link: 'https://todo-9p0apfd7q-fernandos-projects-66f955c3.vercel.app/',
...

    {
      ...
      link: 'https://calculadora-aritimetica-8hf4j06ei-fernandos-projects-66f955c3.vercel.app/',
